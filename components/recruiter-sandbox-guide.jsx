...
export function RecruiterSandboxGuide() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Navigate to 'Groups', select the pre-seeded 'Roommates (Demo)' group, and record a payment. Our greedy reduction algorithm calculates exactly who owes whom in minimum transfers.",
