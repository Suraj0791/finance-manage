...
// Check specifically for Neon Serverless cold start / autosuspend errors
export function isNeonColdStartError(error) {
  // On Neon free tier, these errors commonly indicate the DB is waking up
...
export function handleDatabaseError(error) {
  if (isNeonColdStartError(error)) {
    return {
      error: true,
      message: getErrorMessage(error_codes.NEON_COLD_START),
      code: error_codes.NEON_COLD_START,
    };
  }
